...
awesome.connect_signal(
    ...
    function(value, muted)
        ...
        vol_tooltip.markup = colorize_text(vol_value .. '%', vol_color)
    end
)
...
awesome.connect_signal(
    ...
    function(value)
        ...
        brightness_tooltip.markup = colorize_text(value .. '%', brightness_color)
    end
)
...
watch(
    ...
    function(_, stdout)
        ...
        cpu_tooltip.markup = colorize_text(value .. '%', cpu_color)
    end
)
...
watch(
    ...
    function(_, stdout)
        ...
        ram_tooltip.markup = colorize_text(r_used, ram_color)
