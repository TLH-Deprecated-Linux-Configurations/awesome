...
local animation = require('widget.playerctl.animation')
...
function playerctl.loop(icon_color, bg_color)
	...
	playerctl_daemon:connect_signal(
		'loop_status',
		function(self, loop_status, player)
