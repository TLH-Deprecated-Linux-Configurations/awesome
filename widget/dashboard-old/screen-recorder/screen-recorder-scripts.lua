...
--                         |__|
-- ------------------------------------------------- --
local user_config = require('widget.dashboard.screen-recorder.screen-recorder-config')
local scripts_tbl = {}
                    ...
                    scripts_tbl.user_resolution ..
                        [[ -framerate ]] ..
                            scripts_tbl.user_fps ..
                                [[ -f x11grab \
		-i :0.0+]] ..
                                    scripts_tbl.user_offset .. ' ' .. add_audio_str .. [[ -c:v libx264 -crf 20 -profile:v baseline -level 3.0 -pix_fmt yuv420p $file_name
		]],
