...
--
local screen_rec_backend = require('widget.dashboard.screen-recorder.screen-recorder-scripts')
-- ------------------------------------------------- --
-- The screen-recorder's UI
--
local screen_rec_ui = require('widget.dashboard.screen-recorder.screen-recorder-ui')
-- ------------------------------------------------- --
-- User Preferences
--
