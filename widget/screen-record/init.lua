...
local create_button = require("module.interface.button")
...
local screen_record_tool = function(s)
	...
	local take_screen_record = function()
		...
		elseif snap_area == "window" then
			command = "maim -d " .. delay_sec .. " " .. "-i $(xdotool getactivewindow) " .. screen_record_dir .. file_name
		end
	...
	local screen_record_button = create_button.circle_big(beautiful.icon_camera)
