...
-- widget.functions.serialize.serialize({1,2,3,4, {hello='world'}})
...
-- widget.functions.serialize.deserialize("[1,2,3,4, {hello='world'}]")
...
-- widget.functions.serialize.serialize_to_file("file.json", {1,2,3,4, {hello='world'}})
...
-- local object = widget.functions.serialize.deserialize_from_file("file.json")
