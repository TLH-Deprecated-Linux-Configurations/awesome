...
local batteryHandle = require("widget.hardware.battery")
-- ########################################################################
-- ########################################################################
-- ########################################################################
...
-- widget.hardware.hardware-check.execute("echo hello")
-- ########################################################################
-- ########################################################################
-- ########################################################################
...
-- widget.hardware.hardware-check.hasBattery()
...
-- widget.hardware.hardware-check.hasWifi()
local function wifi()
...
-- widget.hardware.hardware-check.hasBluetooth()
...
-- widget.hardware.hardware-check.has_package_installed("linux-tos")
...
-- widget.hardware.hardware-check.hasFfmpeg()
...
-- widget.hardware.hardware-check.hasSound()
...
-- widget.hardware.hardware-check.getDefaultIP()
...
-- widget.hardware.hardware-check.getRamInfo()
...
-- widget.hardware.hardware-check.getCpuInfo()
...
-- widget.hardware.hardware-check.isWeakHardware()
...
-- widget.hardware.hardware-check.getDisplayFrequency()
