...
-- widget.hardware.battery.getBatteryPath() -- return location of the battery state
...
--  widget.hardware.battery.isBatteryCharging() -- True
...
-- widget.hardware.battery.getBatteryPercentage() -- return percentage of battery
