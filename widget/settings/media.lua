...
return function()
  ...
  refresh = function()
    ...
    if not (sink.name == nil) then
      vol_footer.markup = 'Output: <span font="' .. beautiful.font .. " 10" .. '">' .. sink.name .. "</span>"
    end
    if not (source.name == nil) then
      mic_footer.markup = 'Input: <span font="' .. beautiful.font .. " 10" .. '">' .. source.name .. "</span>"
    end
