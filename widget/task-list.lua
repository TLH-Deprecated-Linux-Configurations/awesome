...
local function list_update(w, buttons, label, data, objects)
  ...
  for i, o in ipairs(objects) do
    ...
    if cache then
      ...
      cb =
        clickable_container(
        wibox.container.margin(wibox.widget.imagebox(HOME .."/.configuration/awesome/theme/icons/tag-list/tag/close.png"), 4, 4, 4, 4)
      )
      ...
      ibm = wibox.container.margin(ib, dpi(2), dpi(2), dpi(2), dpi(2)) -- 12 is default top and bottom margin --app icon
