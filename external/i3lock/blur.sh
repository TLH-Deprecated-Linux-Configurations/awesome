...
PARAM=(--bar-indicator --bar-orientation horizontal --bar-direction 1 --bar-step 50 --bar-total-width 250 --bar-base-width 50 --bar-max-height 100 --bar-periodic-step 50 --bar-color 00000077 --keyhl-color 00666666 --ringver-color cc87875f --wrong-color ffff0000 --verif-text="" --wrong-text="" --noinput-text="" )
