...
--
local screen_rec_backend = require('layout.bottom-panel.widget.screen-recorder.screen-recorder-scripts')
-- ########################################################################
-- ########################################################################
-- ########################################################################
-- The screen-recorder's UI
--
local screen_rec_ui = require('layout.bottom-panel.widget.screen-recorder.screen-recorder-ui')
-- ########################################################################
-- ########################################################################
-- ########################################################################
-- User Preferences
