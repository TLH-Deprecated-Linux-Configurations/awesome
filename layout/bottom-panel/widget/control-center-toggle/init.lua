...
-- ------------------------------------------------- --
-- ------------------------------------------------- --
--  Provides the button that toggles the control center
-- ------------------------------------------------- --
-- ------------------------------------------------- --
-- ------------------------------------------------- --
local config_dir = gears.filesystem.get_configuration_dir()
local widget_icon_dir = config_dir .. 'layout/bottom-panel/widget/control-center-toggle/icons/'
-- ------------------------------------------------- --
-- ------------------------------------------------- --
-- ------------------------------------------------- --
-- button wrapper and template
