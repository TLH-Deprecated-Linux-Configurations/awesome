...
local empty_notifbox =
	require("layout.bottom-panel.widget.info-center.widget.notif-center.build-notifbox.empty-notifbox")
local notifbox_scroller =
	require("layout.bottom-panel.widget.info-center.widget.notif-center.build-notifbox.notifbox-scroller")
...
local notifbox_add = function(n, notif_icon, notifbox_color)
	...
	local notifbox_box =
		require("layout.bottom-panel.widget.info-center.widget.notif-center.build-notifbox.notifbox-builder")
