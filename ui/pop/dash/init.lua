...
local volume_bar = require('ui.widgets.volume.volume_arc')
...
local brightness_bar = require('ui.widgets.brightness.brightness_arc')
...
local ram_bar = require('ui.widgets.ram.ram_arc')
...
local disk_bar = require('ui.widgets.disk.disk_arc')
...
local temp_bar = require('ui.widgets.temp.temp_arc')
...
-- local cpu = require("ui.widgets.cpu.cpu_arc")

local cpu_bar = require('ui.widgets.cpu.cpu_arc')
...
local playerctl = require('ui.widgets.playerctl.playerctl')
...
awful.screen.connect_for_each_screen(
    function(s)
        if s == screen.primary then
            ...
            s.dash = helpers.screen_mask(s, beautiful.exit_screen_bg or beautiful.xbackground .. '80')
        end
    end
)
-- ########################################################################
