...
-- ########################################################################
-- ########################################################################
-- TODO make it so the minimized windows and those behind maximized windows actually are displayed, current implementation is trash
-- Supposed to show all windows on current tag(s) to make selection possible
--
