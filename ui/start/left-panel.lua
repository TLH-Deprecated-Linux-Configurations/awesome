...
-- TODO eliminate some of this 0R add it to helpers

local dpi = require('beautiful').xresources.apply_dpi
local mat_list_item = require('lib.material.list-item')
local mat_icon = require('lib.material.icon')
local signals = require('lib.signals')
local animate = require('lib.material.animations').createAnimObject
local seperator_widget = require('lib.material.separator')
local card = require('lib.material.card')
local button = require('lib.material.button')

local get_screen = require('lib.focused_screen')
...
local left_panel_func = function()
    ...
    local function settings_plugin()
        ...
        local table_widget =
            wibox.widget {
            topSeparator,
            require('ui.start.left-panel.dashboard.quick-settings'),
            require('ui.start.left-panel.dashboard.hardware-monitor')(s),
            separator,
