...
awesome.connect_signal(
    ...
    function(title, artist, art_path)
        ...
        title_widget:set_markup_silently('<span foreground="' .. beautiful.xcolor5 .. '">' .. title .. '</span>')
        artist_widget:set_markup_silently('<span foreground="' .. beautiful.xcolor6 .. '">' .. artist .. '</span>')
    end
)
