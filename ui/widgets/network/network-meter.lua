...
local mat_slider = require('lib.material.progress_bar')
local mat_icon = require('lib.material.icon')
local icons = require('theme.icons.matangi')
local dpi = require('beautiful').xresources.apply_dpi
local filehandle = require('lib.file')
local gears = require('gears')
local helpers = require('helpers')

local delayed_timer = require('lib.delayed_timer')
...
local function _draw_results(download, upload)
    ...
    -- ########################################################################
    -- ########################################################################
    local download_text = helpers.bytes_to_grandness(download)
    local upload_text = helpers.bytes_to_grandness(upload)
    -- ########################################################################
    -- ########################################################################
    -- ########################################################################
