...
local awesome_overrides = function(theme)
    ...
    theme.tooltip_bg = {
        ...
        stops = {
            ...
            {0.45, theme.xcolor7 .. "33"},
            {0.85, theme.xcolor18 .. "33"},
    ...
    theme.tasklist_bg_urgent = {
        ...
        stops = {
            {0, theme.xbackground .. "33"},
            {0.45, theme.xcolor9 .. "33"},
            {0.85, theme.xcolor21 .. "33"},
            {1, theme.xcolor19 .. "33"}
        }
    }
    -- foreground
