...
-- Font
--
theme.font = "Nineteen Ninety Seven Regular  9"
theme.font_bold = "Nineteen Ninety Seven Bold  9"
-- ------------------------------------------------- --
-- ------------------------------------------------- --
-- ------------------------------------------------- --
-- Menu icon theme
...
local awesome_overrides = function(theme)
	...
	--
	theme.wallpaper = theme.dir .. "/wallpapers/2.png"
	-- ------------------------------------------------- --
	-- ------------------------------------------------- --
	-- ------------------------------------------------- --
	-- Section: Color
	...
	theme.exit_screen_font = "Nineteen Ninety Seven Regular  16"
	-- ------------------------------------------------- --
	-- ------------------------------------------------- --
	-- ------------------------------------------------- --
	-- Hotkey popup
	--
	theme.hotkeys_font = "Nineteen Ninety Seven Regular  11"
	theme.hotkeys_description_font = "Nineteen Ninety Seven Regular  9"
