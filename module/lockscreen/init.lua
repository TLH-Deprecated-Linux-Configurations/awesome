-- Get some widgets
local profile = require 'module.lockscreen.profile'
local clock = require 'module.lockscreen.clock'
local powerbutton = require 'module.lockscreen.powerbutton'
...
local lockscreen =
	...
	ontop = true,
	visible = false,
	bg = colors.alpha(colors.black, '99')
}
