...
local stats =
	wibox.widget(
	{
		create_boxed_widget(cpu(), dpi(115), dpi(120), beautiful.bg_button),
		create_boxed_widget(temperature(), dpi(115), dpi(120), beautiful.bg_button),
		create_boxed_widget(ram(), dpi(115), dpi(120), beautiful.bg_button),
		create_boxed_widget(hdd(), dpi(115), dpi(120), beautiful.bg_button),
		forced_num_cols = 2,
		forced_num_rows = 2,
