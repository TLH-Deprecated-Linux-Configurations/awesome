...
naughty.config.icon_dirs = {"/usr/share/icons/Papirus-Dark", "/usr/share/icons/Papirus/", "/usr/share/icons/Tela",
                            "/usr/share/icons/Tela-blue-dark", "/usr/share/icons/la-capitaine-icon-theme/",
                            "/usr/share/icons/gnome/", "/usr/share/icons/hicolor/", "/usr/share/pixmaps/"}
naughty.config.icon_formats = {"svg", "png", "jpg", "gif"}

local theme = beautiful.primary

signals.connect_primary_theme_changed(function(new_theme)
    theme = new_theme
end)
                                    ...
                                    {
                                        {
                                            {
                                                {
                                                    markup = (n.title or n.app_name) or
                                                        i18n.translate("System Notification"),
                                                    font = "SF Pro Text Regular 10",
                                                    align = "center",
                                                    valign = "center",
                                                    widget = wibox.widget.textbox
