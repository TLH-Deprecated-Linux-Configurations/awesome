...
-- module.hardware-check.execute("echo hello")
-- ########################################################################
-- ########################################################################
-- ########################################################################
...
-- module.hardware-check.hasBattery()
...
-- module.hardware-check.hasBluetooth()
...
-- module.hardware-check.has_package_installed("linux-tos")
...
-- module.hardware-check.hasFfmpeg()
...
-- module.hardware-check.hasSound()
...
-- module.hardware-check.getDefaultIP()
...
-- module.hardware-check.getRamInfo()
...
-- module.hardware-check.getCpuInfo()
...
-- module.hardware-check.isWeakHardware()
...
-- module.hardware-check.getDisplayFrequency()
