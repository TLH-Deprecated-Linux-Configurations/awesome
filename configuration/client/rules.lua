...
-- ########################################################################
{
    rule_any = {
        ...
        "Wpa_gui", "veromix", "mini panel", "Popup", "popup", "dialog", "Dialog", "xtightvncviewer"},
...
{
    rule_any = {
        class = {"Pinentry-gtk-2", "pinentry-gtk-2", "Pinentry-gtk", "pinentry-gtk"}
    },
    properties = {
        floating = true,
        placement = awful.placement.centered,
