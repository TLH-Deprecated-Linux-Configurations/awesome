...
awful.key({modkey, "Cotrol"}, "Page_Up", function()
    -- tag_view_nonempty(-1)
...
awful.key({modkey, "Cotrol"}, "Page_Down", function()
    -- tag_view_nonempty(1)
    local focused = awful.screen.focused()
    for i = 1, #focused.tags do
        awful.tag.viewidx(1, focused)
...
awful.key({modkey, "Control"}, "F2", function()
...
awful.key({modkey, "Mod1"}, "F3", function()
...
awful.key({modkey, "Control"}, "F4", function()
...
-- Standard program
awful.key({modkey}, "r", _G.awesome.restart, {
    description = "Reload Awesome",
    group = "Awesome"
}), -- #############################################################################
awful.key({modkey, "Control"}, "x", _G.awesome.quit, {
