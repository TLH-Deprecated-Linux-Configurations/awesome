...
local function setup_state(state)
	...
	volume.set_volume(state.volume or 100)
	...
	awful.spawn("brightnessctl set 255 --save ") -- reset pixel values
	awful.spawn("brightnessctl set " .. math.max(state.brightness, 5) .. " --save")
...
-- ########################################################################
-- ########################################################################
signals.connect_volume_is_muted(function(is_muted)
