...
local batteryHandle = require('lib.battery')
-- ########################################################################
-- ########################################################################
-- ########################################################################
...
-- module.hardware.hardware-check.execute("echo hello")
-- ########################################################################
-- ########################################################################
-- ########################################################################
...
-- @usage -- This True if it is a laptopB
-- module.hardware.hardware-check.hasBattery()
...
-- module.hardware.hardware-check.hasWifi()
local function wifi()
...
-- module.hardware.hardware-check.has_package_installed("linux-tos")
...
-- module.hardware.hardware-check.hasFfmpeg()
...
-- module.hardware.hardware-check.hasSound()
...
-- module.hardware.hardware-check.getDefaultIP()
...
-- module.hardware.hardware-check.getCpuInfo()
...
-- module.hardware.hardware-check.isWeakHardware()
...
-- module.hardware.hardware-check.getDisplayFrequency()
