...
return function()
    ...
    -- @staticfct lib.datastrucuture.binary-tree.contains
    ...
    -- @staticfct lib.datastrucuture.binary-tree.insert
    ...
    -- @staticfct lib.datastrucuture.binary-tree.remove
