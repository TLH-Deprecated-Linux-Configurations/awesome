...
-- @tdedatamod lib.datastructure.hashmap
---------------------------------------------------------------------------

--- Create a new hashmap
-- @treturn table A table containing the hashmap methods
-- @staticfct lib.datastrucuture.hashmap
-- @usage -- This will create a new empty hashmap
-- lib.datastrucuture.hashmap()
return function()
    local _data = {}
    ...
    -- @staticfct lib.datastrucuture.hashmap.add
    ...
    -- @tparam string key The key used to identify the value
    -- @staticfct lib.datastrucuture.hashmap.delete
    ...
    -- @tparam string key The key used to identify the value
    -- @staticfct lib.datastrucuture.hashmap.get
