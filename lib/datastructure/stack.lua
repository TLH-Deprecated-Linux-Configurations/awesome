...
--
--    local stack = require("lib.datastructure.stack")
--    local list = stack()
--    list.push("first")
--    list.push("second")
...
-- @tdedatamod lib.datastructure.stack
-- @supermodule table
---------------------------------------------------------------------------

--- Create a new Stack
-- @treturn table An empty stack
-- @staticfct lib.datastrucuture.stack
-- @usage -- This will create a new stack
-- lib.datastrucuture.stack()
local function genList()
    ...
    -- @staticfct lib.datastrucuture.stack.push
    ...
    -- @staticfct lib.datastrucuture.stack.pop
    ...
    -- @returns object The object that is next in line in the stack
    -- @staticfct lib.datastrucuture.stack.next
    -- @usage -- Return 'tde' from the stack
    -- stack.next()
    list.next = function()
    ...
    -- @staticfct lib.datastrucuture.stack.size
