...
--
--    lib.hardware-check.battery() -- returns True if a battery exists
--    lib.hardware-check.wifi() -- returns True if wifi is supported
--    lib.hardware-check.bluetooth() -- returns True if bluetooth is supported
--    lib.hardware-check.sound() -- returns True if sound is working
--
...
--
--    lib.hardware-check.has_package_installed("ffmpeg") -- returns True if ffmpeg is installed
--
-- Warning never try to use `lib.hardware-check.execute` unless you known what you are doing.
...
--
--    lib.hardware-check.execute("sleep 2") -- block the main thread for 2 seconds
--
