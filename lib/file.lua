...
--
--    lib.file.exists("/etc/passwd") -- returns true on TOS
--    lib.file.exists("/this/does/not/exist") -- returns false
--
-- You can also do the same for directories
--
--    lib.file.dir_exists(os.getenv("HOME") .. "/.config") -- returns true on systems with default XDG_CONFIG_DIR support
--    lib.file.dir_exists("/this/does/not/exist/") -- returns false
--
...
--
--    lib.file.string(os.getenv("HOME") .. "/file.txt") -- returns abcdefg
--
...
--
--    lib.file.lines(os.getenv("HOME") .. "/file.txt") -- returns {1: "line one", 2: "line two", 3: "line three"}
--
-- @author Tom Meyers
...
-- lib.file.basename("/sys/class/power_supply/BAT0/file.txt")
...
-- lib.file.dirname("/sys/class/power_supply/BAT0/file.txt")
...
-- @usage
-- lib.file.dir_create(os.getenv("HOME") .. "/.cache/tde/some_dir")
...
-- @staticfct overwrite
-- @usage -- This true
-- lib.file.overwrite("hallo.txt", "this is content in the file")
...
-- @staticfct write
-- @usage -- This true
-- lib.file.write("hallo.txt", "this is content in the file")
...
-- lib.file.lines("/etc/hosts", "[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}.*", 100) -> is of type table
...
-- @staticfct string
-- @usage -- This gives the first 100 lines of /etc/hosts and filters it by only showing lines that start with ipv4 addresses
-- lib.file.string("/etc/hosts", "[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}.*", 100) -> is of type string
...
-- lib.file.list_dir("/etc") -> {1:"/etc/passwd", 2:"/etc/shadow", 3:"/etc/hosts", ...}
...
-- @usage -- This returns a table
-- lib.file.list_dir_full("/etc") -> {1:"/etc/passwd", 2:"/etc/ssh/sshd_config", 3:"/etc/pacman/pacman.conf", ...}
