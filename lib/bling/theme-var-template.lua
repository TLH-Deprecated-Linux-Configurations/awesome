...
theme.tabbar_fg_normal = '#f4f4f7' -- foreground color of the focused client on the tabbar
...
theme.tag_preview_client_border_color = '#f4f4f7' -- The border color of each client
...
theme.tag_preview_widget_border_color = '#f4f4f7' -- The border color of the widget
