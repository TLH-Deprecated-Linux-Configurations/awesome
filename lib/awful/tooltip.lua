...
function tooltip:get_preferred_positions()
    return self._private.preferred_positions or {"top", "right", "left", "bottom"}
end
...
function tooltip.new(args)
    ...
    self._private.shape = args.shape or beautiful.tooltip_shape or shape.rectangle
    self._private.gaps =
        args.gaps or beautiful.tooltip_gaps or
        {
            left = args.gaps or 0,
    ...
    -- textbox
    local font = args.font or beautiful.tooltip_font or beautiful.font .. ' 10'
    -- marginbox
    local m_lr = args.margin_leftright or dpi(5)
    local m_tb = args.margin_topbottom or dpi(3)
    -- backgroundbox
    local bg = args.bg or beautiful.tooltip_bg or beautiful.bg_focus or "#ffcb60"

    local border_width = args.border_width or beautiful.tooltip_border_width or 0
    local border_color =
        args.border_color or beautiful.tooltip_border_color or beautiful.border_color_normal or "#ffcb60"
    ...
    awesome.connect_signal(
        "TDE::background::theme::changed",
        function(_)
            bg = args.bg or beautiful.tooltip_bg or beautiful.bg_focus or "#ffcb60"
            self.widget.bg = bg
        end
    )
