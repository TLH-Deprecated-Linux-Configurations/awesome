...
package.path = package.path .. ";" .. home .. ".config/awesome/lib/lib-lua/?/?.lua;" .. home .. ".config/awesome/lib/lib-lua/?.lua"
...
package.cpath = package.cpath .. ";" .. home .. ".config/awesome/lib/lib-so/?/?.so;" .. home .. ".config/awesome/lib/lib-so/?.so"
