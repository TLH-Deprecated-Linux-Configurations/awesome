-- A temporary fix to solve the pixel-perfection of wibox.layout.align
---------------------------------------------------------------------------
--
...
function align:layout(context, width, height)
    ...
    if self._private.expand == "outside_with_minimum" then
        ...
        if size_remains < 0 then
            ...
            if size_diff < 0 then
                local add_to_first =
                    math.ceil(math.min(size_remains, -size_diff) + math.max(0, size_remains + size_diff) / 2)
    ...
    if self._private.first then
        ...
        elseif self._private.expand ~= "outside" then
            ...
            if self._private.dir == "y" then
                h = math.floor(size_remains / 2)
            else
                w = math.floor(size_remains / 2)
            end
        end
    ...
    if self._private.third then
        ...
        elseif self._private.expand ~= "outside" then
            ...
            if self._private.dir == "y" then
                h = math.ceil(size_remains / 2)
            else
                w = math.ceil(size_remains / 2)
            end
        end
