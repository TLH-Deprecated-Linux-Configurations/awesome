...
local focusmap = require("config.keys.maps.focus")
local applicationsmap = require("config.keys.maps.applications")
local awesomemap = require("config.keys.maps.awesome")
local layoutmap = require("config.keys.maps.layout")
